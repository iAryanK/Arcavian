...
export const ModalTrigger = ({
  ...
  return (
    <Button
      className={cn(
        "relative overflow-hidden rounded-md px-8 text-center max-sm:w-full",
        className,
      )}
      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "relative z-50 flex max-h-[90%] min-h-[50%] flex-1 flex-col overflow-hidden rounded-2xl border border-transparent bg-white dark:border-neutral-800 dark:bg-neutral-950 lg:max-w-[40%]",
              className,
            )}
            initial={{
              opacity: 0,
...
export const ModalFooter = ({
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-end bg-gray-100 p-4 dark:bg-neutral-900",
        className,
      )}
    >
      {children}
